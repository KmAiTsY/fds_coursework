...
<body class="content">
		...
		<div class="collapse navbar-collapse" id="navbarTogglerDemo01">
			...
			<ul class="navbar-nav mr-auto mt-2 mt-lg-0">
				...
				<li class="nav-item active">
					<a class="nav-link" href="#">Кошик<span class="sr-only">(current)</span></a>
				</li>
				<li class="nav-item">
	...
	<div class="container my-5">
		...
		<h2 class="display-4"><i class="fas fa-shopping-basket"></i> Кошик</h2>

		<table id="cart" class="table table-hover table-condensed">
			<tr>
				<th style="width:60%">Інфо товара</th>
				<th style="width:10%">Ціна</th>
				<th style="width:15%">Кількість</th>
				<th style="width:15%">Всього</th>
			</tr>
			<?php
			...
			<?php
				...
				echo '<tr><td colspan="5"><p>Нічого немає в кошику :( <br><small>Замовте товар зараз!</small></p></td></tr>';
			}
			...
			<tr>
				...
				<td>
					<span>Ціна товару</span></br>
					<span>Доставка сервіса</span></br>
					<span>Всього</span>
				</td>
				<td>
					<span>
					...
					<td colspan="2">
						<div class="form-group">
							<label class=" mr-4"><input type="radio" class="form-input" name="payment" value="cash" checked>
								<i class="fas fa-wallet"></i> Готівкою </label>
						...
						<div id="cash">
							<form action="checkout" method="get">
								...
								<button type="submit" class="btn btn-success btn-block" id="checkout"> Підтвердити замовлення
