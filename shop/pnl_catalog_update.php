...
<body>
	<div class="container">
		...
		<div class="row p-4">
			<div class="col">
				<h2 class="border-bottom">Обновити каталог</h2>
					...
					?>
						...
						<div class="row py-2">
							...
							<div class="col-3">
								...
								<?php echo '<img class="img-fluid" width="150" src="../img/menu/' . $row['ctlog_img'] . '" alt="Немає зображення">'; ?>
						...
						<div class="row py-2">
							<div class="col">
								...
								<input type="submit" name="submit" class="btn btn-info" value="Обновити">

								<a class="btn btn-danger" href="pnl_catalog_update?act=delctlog&id='<?php echo encryptIt($row['ctlog_id']); ?>'">Видалити</a>
							</div>
						</div>
					<?php
					}
