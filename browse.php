...
<body class="content">
		...
		<div class="collapse navbar-collapse" id="navbarTogglerDemo01">
			...
			<ul class="navbar-nav mr-auto mt-2 mt-lg-0">
				...
				<li class="nav-item active">
					<a class="nav-link" href="#">Товар <span class="sr-only">(current)</span></a>
				</li>
				<li class="nav-item">
			...
			<div class="my-2 my-lg-0">
				<ul class="navbar-nav ml-auto">
					...
					?>
						<a href="index?act=login" class="btn btn-outline-success my-2 my-sm-0">Авторизація</a>
					<?php
					}
					?>
				</ul>
	...
	<div class="container my-5" id="browse_box">
		<div class="row">
			<div class="col-8">
				<h2 class="display-4 text-light"><i class="fas fa-book-open"></i> Меню товарів</h2>
			</div>
			<div class="col-4">
				<div class="input-group mt-4">
					<input type="text" id="search_query" class="form-control" placeholder="Шукати..">
				</div>
			</div>
		</div>
		<?php
					...
					?>
						...
						<div class="card text-left" style="width: 18rem;">
							...
							<div class="card-body">
								...
								<p class="card-text text-capitalize"><?php echo "Магазин: " . $itm_shp; ?></p>
							</div>
							<div class="card-footer text-right" id="<?php echo encryptIt($itm_id); ?>">
								<h5 class="card-text float-left text-success"><?php echo number_format($itm_prc, 2); ?> грн</h5>
								<a href="browse?act=add&id=<?php echo encryptIt($itm_id); ?>" class="btn btn-success ">Добавити в кошик</a>
							</div>
						</div>
					<?php
					}
